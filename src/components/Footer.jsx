  ...
  return (
    <footer className="footer">
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              <img src={logo} alt="BingeBite" className="footer-logo-img" />
              <span><span className="text-orange">Binge</span>Bite</span>
            </Link>
          ...
          <div className="footer-contact">
            ...
            <div className="contact-item">
              ...
              <span>support@bingebite.com</span>
            </div>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} BingeBite. All rights reserved.</p>
      </div>
    </footer>
  );
}
