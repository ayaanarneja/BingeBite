...
import { FALLBACK_FOOD_IMAGE } from '../data/mockData';
...
export default function FoodModal({ food, onClose }) {
  ...
  const imgSrc = imgError ? FALLBACK_FOOD_IMAGE : food.image;
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="modal-image-container">
            <img src={imgSrc} alt={food.name} className="modal-image" onError={() => setImgError(true)} />
            <button 
