    ...
    <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
      <div className="navbar-container container">
        <Link to="/" className="navbar-logo">
          <img src={logo} alt="BingeBite" className="navbar-logo-img" />
          <span className="navbar-logo-text"><span className="text-orange">Binge</span>Bite</span>
        </Link>

        <LocationPicker className="navbar-location" />
